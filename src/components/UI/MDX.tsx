...
export const MDX = {
  ...
  h2: ({className, ...props}: React.HTMLAttributes<HTMLHeadingElement>) => {
    ...
    return <h2 id={anchorId} className={cn('scroll-mt-28 uppercase mt-10 text-neutral-500 mb-4 text-3xl sm:text-2xl font-semibold tracking-tight', className)} {...props} />
  },
  ...
  p: ({className, ...props}: React.HTMLAttributes<HTMLParagraphElement>) => <p className={cn('my-6', className)} {...props} />,
